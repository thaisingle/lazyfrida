...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/CertificatePinner$Companion;-><init>(Lpe/e;)V
...
.method public synthetic constructor <init>(Ljava/util/Set;Lokhttp3/internal/tls/CertificateChainCleaner;ILpe/e;)V
    .locals 0
...
.method public static final sha1Hash(Ljava/security/cert/X509Certificate;)Llh/l;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Llh/l;
...
.method public static final sha256Hash(Ljava/security/cert/X509Certificate;)Llh/l;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Llh/l;
...
.method public final check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Loe/a;)V
...
.method public final varargs check(Ljava/lang/String;[Ljava/security/cert/Certificate;)V
    ...
    invoke-static {p2}, Lah/j;->P1([Ljava/lang/Object;)Ljava/util/List;
...
.method public final check$okhttp(Ljava/lang/String;Loe/a;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v4, v2}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Llh/l;

    move-result-object v4

    :cond_3
    invoke-virtual {v6}, Lokhttp3/CertificatePinner$Pin;->getHash()Llh/l;

    move-result-object v6

    invoke-static {v6, v4}, Lfe/v;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v5, v2}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Llh/l;
...
.method public final findMatchingPins(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_1
    invoke-static {v1}, Lhe/f;->e(Ljava/lang/Object;)Ljava/util/List;
