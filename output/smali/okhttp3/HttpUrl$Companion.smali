...
.method private final writeCanonicalized(Llh/i;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V
    .locals 13
    ...
    :goto_1
    invoke-virtual {p1, v7}, Llh/i;->i0(Ljava/lang/String;)V
    ...
    invoke-static {v9, v7}, Lah/n;->Y1(Ljava/lang/CharSequence;C)Z
    ...
    :cond_6
    invoke-virtual {p1, v6}, Llh/i;->k0(I)V
    ...
    invoke-static {v3, v10}, Lfe/v;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v5, p2, v4, v10, v3}, Llh/i;->h0(Ljava/lang/String;IILjava/nio/charset/Charset;)Llh/i;

    goto :goto_5

    :cond_b
    :goto_4
    invoke-virtual {v5, v6}, Llh/i;->k0(I)V

    :goto_5
    invoke-virtual {v5}, Llh/i;->v()Z

    move-result v10

    if-nez v10, :cond_c

    invoke-virtual {v5}, Llh/i;->readByte()B

    move-result v10

    and-int/lit16 v10, v10, 0xff

    invoke-virtual {p1, v8}, Llh/i;->b0(I)V
    ...
    invoke-virtual {p1, v11}, Llh/i;->b0(I)V
    ...
    invoke-virtual {p1, v10}, Llh/i;->b0(I)V
...
.method private final writePercentDecoded(Llh/i;Ljava/lang/String;IIZ)V
    .locals 5
    ...
    invoke-virtual {p1, p3}, Llh/i;->b0(I)V
    ...
    :cond_1
    invoke-virtual {p1, v0}, Llh/i;->k0(I)V
...
.method public final canonicalize$okhttp(Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-static {v5, v1}, Lah/n;->Y1(Ljava/lang/CharSequence;C)Z
    ...
    invoke-direct {v12}, Llh/i;-><init>()V

    move v0, p2

    invoke-virtual {v12, p1, p2, v3}, Llh/i;->j0(Ljava/lang/String;II)V
    ...
    invoke-direct/range {v0 .. v10}, Lokhttp3/HttpUrl$Companion;->writeCanonicalized(Llh/i;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V

    invoke-virtual {v12}, Llh/i;->T()Ljava/lang/String;
...
.method public final percentDecode$okhttp(Ljava/lang/String;IIZ)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2, v4}, Llh/i;->j0(Ljava/lang/String;II)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/HttpUrl$Companion;->writePercentDecoded(Llh/i;Ljava/lang/String;IIZ)V
...
.method public final toQueryNamesAndValues$okhttp(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v3, v2, v1, v4}, Lah/n;->g2(Ljava/lang/CharSequence;CIZI)I
    ...
    invoke-static {p1, v6, v2, v1, v4}, Lah/n;->g2(Ljava/lang/CharSequence;CIZI)I
...
.method public final toQueryString$okhttp(Ljava/util/List;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v0, v1}, Lm5/f;->O(II)Lue/f;

    move-result-object v0

    const/4 v1, 0x2

    invoke-static {v0, v1}, Lm5/f;->M(Lue/f;I)Lue/d;

    move-result-object v0

    iget v1, v0, Lue/d;->v:I

    iget v2, v0, Lue/d;->w:I
