...
# direct methods
.method public constructor <init>(Llh/c0;I)V
    .locals 7
...
.method public constructor <init>(Llh/c0;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Llh/k;
...
.method public synthetic constructor <init>(Llh/c0;IIILpe/e;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Llh/c0;II)V
...
.method private final getName(I)Llh/l;
    .locals 3
    ...
    :goto_0
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Llh/l;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Llh/k;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Llh/l;

    move-result-object p1

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Llh/l;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/http2/Header;

    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Llh/l;Llh/l;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Llh/l;)Llh/l;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Llh/l;Llh/l;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Llh/l;Llh/l;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Llh/l;Llh/l;)V
...
.method public final readByteString()Llh/l;
    .locals 5
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Llh/k;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Llh/k;JLlh/j;)V
    ...
    invoke-interface {v0, v2, v3}, Llh/k;->l(J)Llh/l;
