...
.field private sink:Llh/j;

.field private socket:Ljava/net/Socket;

.field private source:Llh/k;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/connection/RealConnection$Companion;-><init>(Lpe/e;)V
...
.method private final certificateSupportHost(Lokhttp3/HttpUrl;Lokhttp3/Handshake;)Z
    ...
    invoke-static {v3, p2}, Lfe/v;->j(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lz7/e;->b0(Ljava/net/Socket;)Llh/c0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Llh/k;

    invoke-static {v1}, Lz7/e;->W(Ljava/net/Socket;)Llh/a0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Llh/j;
    :try_end_1
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {v5, v3}, Lfe/v;->j(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lw5/c;->q1(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v5, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Loe/a;)V
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Loe/a;)V
    ...
    invoke-static {v3}, Lz7/e;->b0(Ljava/net/Socket;)Llh/c0;
    ...
    invoke-static {v3}, Lz7/e;->W(Ljava/net/Socket;)Llh/a0;
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Llh/j;

    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Llh/k;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Llh/k;

    invoke-static {v0}, Lfe/v;->i(Ljava/lang/Object;)V

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Llh/j;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Llh/k;Llh/j;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, Llh/f0;->timeout(JLjava/util/concurrent/TimeUnit;)Llh/f0;

    invoke-interface {v2}, Llh/a0;->timeout()Llh/f0;
    ...
    invoke-static {v2, p3, v1}, Lah/n;->b2(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Llh/i;->v()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Llh/j;->c()Llh/i;
...
.method private final startHttp2(I)V
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Llh/k;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Llh/k;Llh/j;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 96
    .line 97
    invoke-static {v3, v0, v4}, La2/a;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 265
    .line 266
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->source:Llh/k;

    .line 267
    .line 268
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Llh/j;
...
.method public final isHealthy(Z)Z
    ...
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Llh/k;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Llh/k;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Llh/c0;->timeout()Llh/f0;
    ...
    invoke-virtual {v0, v3, v4, v5}, Llh/f0;->timeout(JLjava/util/concurrent/TimeUnit;)Llh/f0;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Llh/k;Llh/j;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Llh/k;Llh/j;Lokhttp3/internal/connection/Exchange;)V
